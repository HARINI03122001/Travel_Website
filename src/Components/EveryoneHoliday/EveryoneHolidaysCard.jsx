  ...
  return (
    <div className='col-md-6 col-xl-4'>
      <Card className='shadow d-flex flex-sm-row overflow-hidden'>
        <div className='image-div image-hover col-sm-6 d-flex align-items-center justify-content-center px-4 py-5'>
            <h5 className='text-capitalize text-light'>{props.itemTitle}</h5>

        </div>
        <div className='col-sm-6 d-flex align-items-center'>
            <Card.Body className="p-4">
                <p className='mb-0 textcapitalize'>{props.itemSubTitle}</p>
                <p className='price my-2 fw-bold text-green'>{props.itemPrice}</p>
                <p className='mb-0'>per person </p>
            </Card.Body>
            <img src={ChevronRight} alt="chevron-right" className='me-3' height={15} width={15} />
        </div>
