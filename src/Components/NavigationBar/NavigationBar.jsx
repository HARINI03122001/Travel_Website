        ...
        <Navbar expand='lg' className="position-absolute w-100 z-2">
            <Container>
                <Navbar.Brand className="text-light">
                    ...
                    <img src={AirplaneLogo} className="me-2" alt="Airplane Logo" width="30" height="30" />
                        SPACE TRAVEL
                    </Link>
                </Navbar.Brand>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="me-auto w-100 justify-content-center">
                        ...
                        <Nav.Link href='/city-breaks' className="text-light text-capitalize">Citybreaks</Nav.Link>
